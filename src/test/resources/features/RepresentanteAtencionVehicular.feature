...
Feature: Representante Atencion Vehicular
  ...
  Scenario Outline: Se registra nuevo caso
    ...
    Examples: 
      ...
      |1|usuario.test.geo@gmail.com |Rimac2019#|ABA437|987654321|Avenida juan de arona 780, San isidro|referencia de prueba|Registro realizado con 閤ito.|Solicitado| |
      |2|usuario.test.geo@gmail.com |Rimac2019#|ABA438|987654322|tambo real 236|referencia de prueba|Registro realizado con 閤ito.|Solicitado| |
  ...
  Scenario Outline: Registrar placas con atenciones en proceso
    ...
    Examples: 
      ...
      |1|usuario.test.geo@gmail.com |Rimac2019#|ABA437|987654321|Avenida juan de arona 780, San isidro|referencia de prueba|El caso no puede ser registrado. Ya existe otro caso en proceso con la misma placa| |
      |2|usuario.test.geo@gmail.com |Rimac2019#|ABA438|987654322|tambo real 236|referencia de prueba|El caso no puede ser registrado. Ya existe otro caso en proceso con la misma placa| |
      |3|usuario.test.geo@gmail.com |Rimac2019#|ABA439|987654323|Miraflores|referencia de prueba|El caso no puede ser registrado. Ya existe otro caso en proceso con la misma placa| |
