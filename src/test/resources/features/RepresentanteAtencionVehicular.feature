...
Feature: Representante Atencion Vehicular
  ...
  Scenario Outline: Se registra nuevo caso
    ...
    Examples: 
      ...
      |5|usuario.test.geo@gmail.com |Rimac2019#|ABA338|987654324|Avenida juan de arona 780, San isidro|referencia de prueba|Registro realizado con éxito.|Solicitado| |
      |6|usuario.test.geo@gmail.com |Rimac2019#|ABA339|987654322|tambo real 236|referencia de prueba|Registro realizado con éxito.|Solicitado| |
